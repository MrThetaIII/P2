        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not find the product with id: ".concat(id, ". Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'INSERT INTO products (product_name, price, description) VALUES ($1, $2, $3) RETURNING *';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        cnctn = _a.sent();
                        return [4 /*yield*/, cnctn.query(sql, [
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add new product ".concat(product, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not delete product with id: ".concat(id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'UPDATE products SET product_name=($1), price=($2), description=($3) WHERE id=($4) RETURNING *';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        cnctn = _a.sent();
                        return [4 /*yield*/, cnctn.query(sql, [
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Could not update product ".concat(product, ". Error: ").concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
